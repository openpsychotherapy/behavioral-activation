const en = {
    ...
    valuesButtonEnjoyment: 'Spare time/Interests',
    valuesButtonHealth: 'Mind/Body/Spiritually',
    ...
    activityInfo : {
        ...
        "your favorite icons aren´t enough. The menu button in the middle takes you to "+
