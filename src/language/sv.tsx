const sv = {
    ...
    navigationLabelCalendar: 'Planera',
    ...
    valuesButtonEnjoyment: 'Fritid/Intressen',
    ...
    routeNames: {
        ...
        Calendar: 'Kalender',
        CalendarRegistration: "Planera/Ändra aktivitet",
        ...
        ActivityInfo: 'Aktivitetsvyn',
        ValuesInfo: 'Värderingsvyn',
        CalenderInfo: 'Kalendervyn',
    },
}
