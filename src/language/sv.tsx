const sv = {
    ...
    informationCardDepression: "Vad är depression?",
    informationCardBehaviouralactivation: 'Beteendeaktivering',
    informationCardStress: "Stressande livshändelser \noch förluster i ditt liv",
    ...
    routeNames: {
        ...
        DepressionInfo: "Vad är depression?",
        StressInfo: "Stressande livshändelser",
